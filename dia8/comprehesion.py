...
"""
#las siguientes son otras formas de abordar
for i in range(1,n+1): #se establece la operatoria aqui
...
for elemento in lista:
    if type(elemento) is str: #is es para validar de que tipo es el elemento
        count_str += 1
